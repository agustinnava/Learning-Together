$(document).ready(function () {
    ...
    let instituto = localStorage.getItem("instituto");
    let idioma = localStorage.getItem("idioma");
    let hora = localStorage.getItem("hora");
    let precio = localStorage.getItem("precio");
    $("#mensaje1").append(`Inscripción al curso de ${idioma} en la provincia de ${provincia} y sede ${instituto} en el horario ${hora}.`);
    $("#mensaje2").append(`El precio es de ${precio}.-`);
});
...
let hora = localStorage.getItem("hora");
let precio = localStorage.getItem("precio");
$("#mensaje1").append(`<p>Inscripción al curso de ${idioma} en la provincia de ${provincia} y sede ${instituto} en el horario ${hora}.</p>`);
$("#mensaje2").append(`El precio es de ${precio}.-`);